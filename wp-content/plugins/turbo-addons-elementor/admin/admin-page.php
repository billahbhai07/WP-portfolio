        ...
        <div class="trad-dashboard-top-banner-container">
            <div class="trad-dashboard-top-banner-container-60">
                <h3>
                   ...
                   ?>
                👋🏻</h3>
                <p style="font-size:18px">Turbo Addons Pro is now available with full <strong>WooCommerce support, custom header and footer builder, and custom product pages.</strong> You’ll also get 85+ widgets and 100+ ready templates to speed up your design process.
                </p>
                <p style="font-size:18px">Upgrade to Turbo Addons Pro today and unlock the full potential! 🚀 🚀</p>
            </div>
            
            <div class="trad-dashboard-top-banner-container-40">
                <div>
                    <?php 
                        $offerBadge = plugin_dir_url( __FILE__ ) . 'assets/images/seventyoffer.webp';
                    ?> 
                <img style="width: 200px" src="<?php echo esc_url($offerBadge);?>" alt="badge">
                </div>
                <div class="turbo-dashboard-banner-branding">
                   <img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'assets/images/turbo-logo.webp' ); ?>" alt="<?php echo esc_attr( 'turbo-logo' ); ?>">
                    <a href="https://turbo-addons.com/elementor-addons-pricing/" target="blank">
                                <button class="trad-dashboard-top-banner-button" >Explore</button> 
                    </a>
                </div>
             ...
             <!-- ------------------tab1-----section  1// ---------------------------->
                <div class="trad-dashboard-sec-one">
                    <div class="trad-dashboard-sec-one-left">
                        <h3 class="trad-dashboard-sub-heading">What's New in Version 1.8.2</h3>
                        <hr>
                        ...
                        <div class="trad-updated-list-typography">
                            <h4>Updated</h4>
                            <p>New Tooltip Extension added for adding tooltips to any Elementor widget easily.</p>
                        </div>
                        </div>
                        <hr>
                        <div class="trad-updated-list">
                            <img src="<?php echo esc_url(plugin_dir_url(__FILE__) . 'assets/images/updatelist-icon.svg'); ?>" alt="<?php echo esc_attr('update icon'); ?>"> 
                            <div class="trad-updated-list-typography">
                                <h4>Added features to multiple widgets</h4>
                                <p>More flexibility controls across other widgets for improved customization.</p>
                            </div>
                        </div>
                        <hr>
                        <div class="trad-updated-list">
                            ...
                            <div class="trad-updated-list-typography">
                                <h4>Improved</h4>
                                <p>Overall plugin flexibility and security with better PHPCS compliance and code sanitization.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="trad-dashboard-sec-four">
                    ...
                    <div class="trad-dashboard-sec-four-card">
                        <h3 class="trad-dashboard-sub-heading">Explore 85+ Widgets</h3>
                        <p>
                            Discover a powerful collection of 85+ versatile widgets designed to enhance your website’s functionality, creativity, and user experience.
                        </p>  
                        ...
                        <div class="trad-dashboard-center-btn">
                            <a href="https://turbo-addons.com/dynamic-widgets/" target="_blank" rel="noopener" >Explore⤴</a>
                        </div>
                    </div>
                    <div class="trad-dashboard-sec-four-card">
                        ...
                        <div class="trad-dashboard-center-btn">
                            <a href="https://turbo-addons.com/contact/" target="_blank" rel="noopener" >Get Support ⤴</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="premium-tab" class="trad-tab-content tab-content trad-dashboard-premium-tab <?php echo $current_tab === 'premium-tab' ? 'active' : ''; ?>"
                ...
                <div class="trad-header-section">
                    ...
                    <div class="trad_dashboard_pro_tabs_cta">
                        <h3>Discover Our Lates Creation Enjoy Flat 20% Off copy coupon ( Limited Time ) <span class="trad_dashboard_copun"><code>TURBO20</code></span></h3>
