...
function get_promotion_widgets_data() {
    ...
    return [
        ...
        [
            'name' => 'word-count',
            'title' => __('Word Count', 'turbo-addons-elementor'),
...
function get_expert_widgets_data() {
    ...
    return [
        ...
        [
            'name' => 'flip-book',
            'title' => __('Flip Book', 'turbo-addons-elementor'),
...
function get_widget_lists() {
    return [
        ...
        'flipbook-img'                => 'flipbook-img.php',                  // flip box
...
function trad_enqueue_scripts_styles() {   
    ...
    //Fancy Alert
    wp_register_style( 'trad-fancy-alert-style', TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/css/custom-css/fancy-alert.css', [], filemtime( TRAD_TURBO_ADDONS_PLUGIN_PATH . 'assets/css/custom-css/fancy-alert.css' ), 'all' );
    wp_register_script( 'trad-fancy-alert-script', TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/js/fancy-alert.js', [], TRAD_TURBO_ADDONS_PLUGIN_PATH, true );
    ...
    //Accordion
    // wp_register_style( 'trad-accordion-style', TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/css/custom-css/accordion.css', [], filemtime( TRAD_TURBO_ADDONS_PLUGIN_PATH . 'assets/css/custom-css/accordion.css' ), 'all' );
    ...
    //flip book
    wp_register_style( 'trad-flip-book-img-style', TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/css/custom-css/flipbook-img.css', [], filemtime( TRAD_TURBO_ADDONS_PLUGIN_PATH . 'assets/css/custom-css/flipbook-img.css' ), 'all' );
    wp_register_script( 'trad-flip-book-img-script', TRAD_TURBO_ADDONS_PLUGIN_URL . 'assets/js/flipbook-img.js',[], TRAD_TURBO_ADDONS_PLUGIN_VERSION, true );
