    ...
    <div class="trad-single-testimonial text-center trad-testimonial-style--default">
        ...
        if (!empty($settings['testimonial_img']) && $settings['thumbnail_alignment'] === 'top') {
            ...
            if (!empty($img['url'])) {
                ...
                echo '<div class="trad-testimonial-thumb"><img src="' . esc_url($img['url']) . '" alt="' . esc_attr($altText) . '"></div>';
            }
        }
        ...
        if (!empty($settings['testimonial_desc'])) {
            ...
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- safe icon HTML from Elementor
