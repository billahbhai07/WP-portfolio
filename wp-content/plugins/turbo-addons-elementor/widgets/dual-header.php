      ...
      // ----------------------------------header two-----------------------
        ...
        'trad_dual_header_alignment',
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .trad-dual-header-text-container' => 'align-items: {{VALUE}};',
                ],
            ]
        );
     ...
     // ------------------------------------Secondary Text Styling-----------------------------------------------
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'secondary_text_stroke_width_hover[size]!' => '', // only show if stroke width is set
                ],
            ]
        );
        $this->end_controls_tab();
